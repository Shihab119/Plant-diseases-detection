...
# =========================================================
    ...
    st.markdown(
        """
        ### 🌱 প্ল্যান্ট ডিজিজ রিকগনিশন অ্যান্ড অ্যাডভাইসরি সিস্টেম

        এই অ্যাপটি কৃষকদের সহায়তার জন্য তৈরি করা হয়েছে যাতে তারা **পাতার ছবি আপলোড করে সহজেই গাছের রোগ শনাক্ত করতে পারেন**  
        এবং সেই রোগের জন্য **প্রয়োজনীয় ওষুধ, চিকিৎসা পদ্ধতি ও প্রতিরোধমূলক পরামর্শ** পেতে পারেন।

        অ্যাপটি কৃত্রিম বুদ্ধিমত্তা (AI) ও ডিপ লার্নিং ব্যবহার করে কাজ করে, যা দ্রুত ও নির্ভুল ফলাফল প্রদান করে।

        ---
        ### 🔬 ব্যবহৃত প্রযুক্তি (Technologies Used)

        - **TensorFlow & Keras**  
          → গাছের পাতার ছবি থেকে রোগ শনাক্ত করার জন্য ডিপ লার্নিং মডেল  
        - **MobileNetV2 (Transfer Learning)**  
          → কম ডেটাতেও ভালো পারফরম্যান্সের জন্য ব্যবহৃত CNN মডেল  
        - **Streamlit**  
          → সহজ ও ব্যবহারবান্ধব ওয়েব অ্যাপ তৈরির জন্য  
        - **Google Gemini AI (Chatbot)**  
          → কৃষকদের প্রশ্নের উত্তর দেওয়ার জন্য AI চ্যাটবট  
        - **OpenCV (CLAHE)**  
          → ছবির উজ্জ্বলতা ও কনট্রাস্ট উন্নত করার জন্য

        ---
        ### 🎯 অ্যাপের প্রধান বৈশিষ্ট্য

        ✔ গাছের পাতার ছবি থেকে রোগ শনাক্ত  
        ✔ রোগের নাম ও নির্ভুলতার হার (%) প্রদর্শন  
        ✔ রোগের বিবরণ ও কারণ  
        ✔ প্রস্তাবিত ওষুধের নাম ও তথ্য  
        ✔ AI ভিত্তিক কৃষি চ্যাটবট
        ...
        এই অ্যাপটি **সহায়ক পরামর্শ প্রদান করে**, তবে চূড়ান্ত সিদ্ধান্ত নেওয়ার আগে  
        নিকটস্থ কৃষি অফিসার বা বিশেষজ্ঞের সাথে পরামর্শ করা উচিত।

        ---
        ### 👨‍💻 ডেভেলপার তথ্য

        - **Developed by:** Shihab 
        - **Department / Project:** Plant Disease Detection System  
        - **Email:** shihab119@gmail.com 
        - **GitHub:** https://github.com/your-github  

        ---
        🌿 *স্মার্ট কৃষি গড়ে তুলতেই এই উদ্যোগ* 🌿
        """
    )
